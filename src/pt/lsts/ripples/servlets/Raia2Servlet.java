...
public class Raia2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<style>#wrapper {border: 1px #e4e4e4 solid;margin-top: 3%;padding: 2%;border-radius: 4px;box-shadow: 0 0 6px #ccc;background-color: #fff;min-width: 335px; width:55%}</style>");
		out.println("</head>");
