...
public class Raia2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<style>html {font-size: 62.5%;} body {font-size: 14px;font-size: 1.4rem;} #wrapper {border: 1px #e4e4e4 solid;margin-top: 3%;padding: 2%;border-radius: 4px;box-shadow: 0 0 6px #ccc;background-color: #fff;min-width: 300px; width:55%} @media only screen and (max-width: 360px) {table .table-hover tr td{float:left;width:240px;height:100px;list-style: none;}}</style>");
		out.println("</head>");
